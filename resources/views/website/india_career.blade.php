        ...
        <div class="container">
        	  <div class="row">
        	  	<div class="col-lg-12 careershow_dtlsoutarea">
        	  	 	  ...
        	  	 	  <div class="row">
					@if(isset($indiacareers))
            	    @foreach($indiacareers as $list)
                    @php
        	  	 	  	  ...
        	  	 	  	  <div class="col-lg-4">
        	  	 	  	  	 <div class="singlejob_outarea">
        	  	 	  	  	 	  <div class="otop_inneroutarea">
        	  	 	  	  	 	  	<span class="pstdate_textdesign">{{@$list->post_date->format('d/m/Y')}}</span>
        	  	 	  	  	 	  	 ...
        	  	 	  	  	 	  	 <div class="col-lg-7">
        	  	 	  	  	 	  	 	   <div class="aplynow_btnoutarea">
        	  	 	  	  	 	  	 	   	    <button class="anwrgt_btnarea">
        	  	 	  	  	 	  	 	   	    	<a href="{{route('india_career_details')}}/{{@$list->id}}">
        	  	 	  	  	 	  	 	   	    	  Apply Now
